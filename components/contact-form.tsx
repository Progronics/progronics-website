      ...
      <form className="my-8" onSubmit={handleSubmit}>
        <div className="mb-4 flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-2">
          ...
          <LabelInputContainer>
            ...
            <Input required id="lastname" placeholder="Durden" type="text" />
          </LabelInputContainer>
        </div>
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input id="number" placeholder="+xxxxxxxx" type="text" />
        </LabelInputContainer>

         <LabelInputContainer className="mb-4">
          <Label htmlFor="message">Message</Label>
          <Input required id="message" placeholder="Type your message...." type="text" />
        </LabelInputContainer>
