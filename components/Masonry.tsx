...
type DemoCredentials = {
  ...
  insurance?: { email: string; password: string };
  doctor?: { email: string; password: string };
  frontdesk?: { email: string; password: string };
  signup?: { email: string; password: string };
  caregiver?: { email: string; password: string };
  elderly?: { email: string; password: string };
  player1?: { link: string };
  player2?: { link: string };
};
      ...
      {grid.map(item => (
        ...
        />
            ...
            <div className="relative w-full h-full rounded-[10px] overflow-hidden bg-gray-900">
              ...
              {/* Dark overlay with title, description, features */}
